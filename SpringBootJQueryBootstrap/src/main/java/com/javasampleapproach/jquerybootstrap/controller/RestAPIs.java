package com.javasampleapproach.jquerybootstrap.controller;
...
import com.javasampleapproach.jquerybootstrap.model.Address;
import com.javasampleapproach.jquerybootstrap.model.Customer;
...
public class RestAPIs {
	...
	public List<Customer> getResource(){
		List<Customer> custList = custStores.entrySet().stream().map(entry -> entry.getValue()).collect(Collectors.toList());
		return custList;
	}
}
